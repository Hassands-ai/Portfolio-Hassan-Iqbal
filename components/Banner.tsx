...
const Banner = () => {
  return (
    ...
    >
      ...
      >
        I’m a Data Science Intern with a strong foundation in statistics, machine learning, and data analysis. I specialize in using Python, SQL, Matplotlib, Seaborn, Pandas, Scikit-learn, and NumPy to perform data cleaning, exploratory analysis, and model building for real-world solutions.
        <br />
      ...
      <a href="https://github.com/Hassands-ai" target="_blank">
        <motion.button
          initial={{ y: 10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
